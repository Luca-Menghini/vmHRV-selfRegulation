...
<p>
```{r }
respRate <- function(data){ require(Rmisc)
...
knitr::kable(ESM[ESM$idday%in%ESM[duplicated(ESM$idday),"idday"],
...
As a potential additional criterion to be considered as a control, we arbitrarily chose to **flag participants with an overall response rate < 80%** (N = 9 among the included participants).
```{r }
